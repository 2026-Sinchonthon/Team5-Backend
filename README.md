...
| Backend | 창엽 | 로그인 / 회원가입 / 마이페이지 | 학생·점주 회원가입, 대학 이메일 기반 학생 판별, JWT 로그인 및 인증, 회원·프로필 조회 |
| Backend | 민준 | 공고 / LLM 공고 생성 | 공고 등록·조회·수정·취소, 공고 이미지 관리, 조건별 공고 검색, Ollama 기반 AI 공고 정제 |
| Backend | 해윤 | 지원 / 매칭 / 결과물 / 수정 요청 | 공고 지원·수락, 매칭 생성, 결과물 제출·수정 요청·승인 |
